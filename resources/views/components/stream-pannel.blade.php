<div class="relative m-auto w-fill h-full p-5 overflow-y-auto" id="style-1">
    ...
    <div class="w-full h-130" style="background-image: url('{{ asset('img/stream-photo/banners/loltyler1-banner.png') }}'); background-size: cover; background-position: center;">
    ...
    <x-stream-pannel-h>Top 5 Categories</x-stream-pannel-h>

    @php
        $list = ['Just Chatting', 'Grand Theft Auto 5', 'PUBG', 'Slot & Casino', 'Dota 2', 'Rust', 'IRL', 'Among Us', 'League of Legends', 'Sons of the Forest', 'Counter-Strike 2', 'Chess'];
    @endphp
